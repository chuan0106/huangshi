 ...
 * @LastEditors: yuchang
 * @LastEditTime: 2023-05-26 15:12:51
 * @Description: 
 */
...
const Index = ({ Map, activeLayerObj }) => {
    ...
    return (
        <div className={styles.IframeWarp} id="IframeWarp">
            ...
            <Screen yearAndMonth={yearAndMonth} area={area} industry={industry} />
            ...
            <div id="myMap" className={`${styles.myIframe1} `} >
                ...
                <XzPolygonLayer clickMap={clickFun} />
                {Map && <NewIconLayer mapHandler={mapHandler} />}
            </div>
            <Topics clickCy={(ind) => { setIndustry(ind) }} area={area} industry={industry} />
        </div>
    );
};
