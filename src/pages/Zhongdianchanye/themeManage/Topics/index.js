    ...
    return (
        <Fragment>
            ...
            <div className={styles.tableLeft}>
                {tableDataLeft?.length >= 1 && <TableLeft dataSource={tableDataLeft} columns={columnsLeft} isScroll={true} rowClassName={{ oddStyle: { color: '#fff', background: '#103066', fontSize: '18px' }, evenStyle: { color: '#FFF2D6', background: '#0D2954', fontSize: '18px' } }} />}
            </div>
