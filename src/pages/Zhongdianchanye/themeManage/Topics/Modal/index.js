 ...
 * @LastEditors: yuchang
 * @LastEditTime: 2023-05-30 20:22:05
...
const Index = ({ isModal, modalHandler, companyData }) => {
            ...
            <Fragment>
                <div className={styles.messageBox}>
                    <div className={styles.left}>
                        <div style={{ width: '980px' }} className={styles.item}>
                            <div className={styles.key}>企业名称</div>
                            <div className={styles.value}>{companyData?.f0002}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>注册日</div>
                            <div className={styles.value}>{companyData?.f0005}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>营业期限</div>
                            <div className={styles.value}>-</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key} title={companyData?.f0027}>注册地址</div>
                            <div className={styles.value}>{companyData?.f0027}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key} title={companyData?.f0027}>经营地址</div>
                            <div className={styles.value}>{companyData?.f0027}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>营业网址</div>
                            <div className={styles.value} title={companyData?.f0031} >{companyData?.f0031}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>经营范围</div>
                            <div className={styles.value} title={companyData?.f0025} >{companyData?.f0025}</div>
                        </div>
                    </div>
                    <div className={styles.right}>
                        <div className={styles.item}>
                            <div className={styles.key}>统一社会代码</div>
                            <div className={styles.value}>{companyData?.f0019}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>法定代表人</div>
                            <div className={styles.value}>{companyData?.f0022}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>注册资本</div>
                            <div className={styles.value}>{companyData?.f0023}</div>
                        </div>

                        <div className={styles.item}>
                            <div className={styles.key}>联系方式</div>
                            <div className={styles.value}>{companyData?.f0030}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>邮箱编码</div>
                            <div className={styles.value}>{companyData?.f0028}</div>
                        </div>
                        <div className={styles.item}>
                            <div className={styles.key}>企业邮箱</div>
                            <div className={styles.value}>{companyData?.f0029}</div>
                        </div>
                    </div>
                </div>
            </Fragment>
    ...
    return (
        <div style={{ display: !isModal ? 'none' : 'block' }} className={`${styles.modal} ${isModal ? styles.fadeIn : styles.fadeEnd}`}>
            ...
            <div className={styles.title}>{companyData?.f0002}</div>
            {/* 顶部按钮 */}
            {/* {list.map(item => (
