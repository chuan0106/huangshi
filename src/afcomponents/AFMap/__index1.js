...
// deck.gl图层
import { DScatterplotLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/ScatterplotLayer';
import { DTripsLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/TripsLayer';
import { DBitmapLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/BitmapLayer';
import { DArcLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/ArcLayer';
import { DColumnLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/ColumnLayer';
import { DCPUGridLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/CPUGridLayer';
import { DContourLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/ContourLayer';
import { DGeoJsonLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/GeoJsonLayer';
import { DGPUGridLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/GPUGridLayer';
import { DTextLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/TextLayer';
import { DPathLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/PathLayer';
import { DLineLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/LineLayer';
import { DIconLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/IconLayer';
import { DHeatmapLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/HeatmapLayer';
// import { DTerrainLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/TerrainLayer';
import { DSolidPolygonLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/SolidPolygonLayer';
import { DScreenGridLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/ScreenGridLayer';
import { DPolygonLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/PolygonLayer';
import { DGridCellLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/GridCellLayer';
import { DGridLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/GridLayer';
import { DHexagonLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/HexagonLayer';
import { DH3ClusterLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/H3ClusterLayer';
import { DH3HexagonLayer } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/H3HexagonLayer';
import { DScenegraphLayerConfig } from '@/dccomponents/DCMap/ReactDeckGL/DeckGL/ScenegraphLayer';
// mapbox图层
import TextLabelLayers from '@/dccomponents/DCMap/ReactDeckGL/Mapbox/TextLabel';
import HeatLayer from '@/dccomponents/DCMap/ReactDeckGL/Mapbox/HeatLayer';
import HeartbeatLayer from '@/dccomponents/DCMap/ReactDeckGL/Mapbox/HeartbeatLayer';
import FlyingLineLayer from '@/dccomponents/DCMap/ReactDeckGL/Mapbox/FlyingLineLayer';
import WarnImageLayer from '@/dccomponents/DCMap/ReactDeckGL/Mapbox/WarnImageLayer';
import ClusterLayer from '@/dccomponents/DCMap/ReactDeckGL/Mapbox/ClusterLayer';
//弹窗
import Popup from './Pop/MapBoxPop/Popup';
//弹窗
import PopView from './Pop';
//工具
import NavgationControl from '@/dccomponents/DCMap/MapControl';
...
class DMap extends PureComponent {
  ...
  layerClick = (value, info, event) => {
    ...
    console.log('interac34tiveData1111', value, '----------', info, '----------', event);
  ...
  render() {
    ...
    // console.log('adsdfa987sfasdfd', mapController);
    return (
      <DeckGL
        layers={[...deckglLayers]}
        //地图视角相关配置
