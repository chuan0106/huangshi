import networkRequest from '@/utils/network/DCRequest';
...
//新增关联图层
export function create_das_link_layer_style_service(params, workspaceFilterStatus) {
  return networkRequest(
    configPath.create_das_link_layer_style_path,
    params,
    'post',
...
//新建图层飞行相机组
export function create_das_camera_Service(params, workspaceFilterStatus) {
  return networkRequest(configPath.create_das_camera_Path, params, 'post', workspaceFilterStatus);
}
//删除图层飞行相机组
...
//获取指定图层默认交互
export function delLinkStylesService(params) {
  return networkRequest(configPath.delLinkStylesPath, params, 'get');
}
