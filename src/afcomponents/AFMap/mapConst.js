...
import { LayerType } from './lib/spaceojo-gl';
...
// 通过相数云的图层名称获取SDK图层类型枚举
export const layerType = {
  IconLayer: LayerType.IconLayer,
  ScatterplotLayer: LayerType.PointLayer,
  HeartBeatLayer: LayerType.RadiationLayer,
  SizeScatterLayer: LayerType.ClusterLayer,
  CubeLayer: LayerType.GridLayer,
  HexagonLayer: LayerType.HexagonLayer,
  TripsLayer: LayerType.RTTrackLayer,
  HeatmapLayer: LayerType.HeatMapLayer,
  HeatLayer: LayerType.HeatMapLayer,
  ArcLayer: LayerType.Arc,
  LineLayer: LayerType.Line,
  PathLayer: LayerType.PolyLineLayer,
  PolygonLayer: LayerType.PolygonLayer,
  TextLayer: LayerType.Text,
  FlyingLineLayer: LayerType.FlyingLine,
  WarnImageLayer: LayerType.AnimationIcon,
  ScenegraphLayer: LayerType.ModelSymbolLayer,
  textLabelLayer: LayerType.Marker
}; 