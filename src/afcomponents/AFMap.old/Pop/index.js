...
function PopView(props, node) {
  ...
  function interactionBox() {
    ...
    return (
      ...
      >
        {(closeBtn?.status || false) && (
          <span
            ...
            style={{
              ...
              marginTop:
                closeBtn?.marginTop || closeBtn?.marginTop === 0 ? closeBtn?.marginTop : 10,
            }}
            onClick={closePop}
          >
            ×
        ...
        {/* <div className={styles.closePop} onClick={closePop}>
          X
        </div> */}
        {tempDom}
      </div>
  ...
  return !interactionBoxPosition.positionType || interactionBoxPosition.positionType === 2
    ? interactionBox()
    : isDomObj(node) && ReactDOM.render(interactionBox(), node);
}
