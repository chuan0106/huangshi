...
class DMap extends PureComponent {
  ...
  clearMapAllLayer = () => {
    ...
    setTimeout(() => {
      ...
      let deckglLayersbuild = deckglLayers.filter(elem => {
        return elem?.id === 'polygonlayer@6782';
      });
      this.setStateP({
  ...
  layerClick = (value, info, event) => {
    ...
    console.log('11interac34tiveData1111111', value);
    console.log('11interac34tiveData2222222', info);
    console.log('11interac34tiveData33333', event);
