...
export const configPath = {
  getTableFeildPath: IPConfig.userServiceDomain + '/data/v1/find_properties?', //get
  ...
  // 空间过滤
  search_signature_filter:
    IPConfig.datafusionServiceDomain + '/hubble/common/v1/search_space_common_datasource', // post
};
