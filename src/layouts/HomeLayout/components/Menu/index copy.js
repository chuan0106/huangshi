...
//         let viewState1 = {
//             bearing: 2.04545454545453,
//             pitch: 0.8846530077843903,
//             zoom: 9.106531408747953,
//             latitude: 29.908451555700996,
//             longitude: 114.88346474615415
//         }
...
//             payload: item.name === '重点项目' ? viewState1 : viewState2,
//         });
...
//                                     <img src={haedImg} alt="" />
//                                 </div>
//                                 <div style={{ color: item.name === activeName ? '#fff' : 'rgb(148, 155, 170)' }} className={styles.title}>{item.name}</div>
//                             </div>
//                         ))}
//                     </div>
//                 ))}
