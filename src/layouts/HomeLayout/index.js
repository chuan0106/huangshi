 ...
 * @LastEditors: dengtao
 * @LastEditTime: 2023-03-03 13:36:04
 * @FilePath: \cloud\src\layouts\HomeLayout\index.js
 * @Descripttion: 
 */
...
class Home extends React.Component
{
    ...
    render ()
    {
        ...
        const { children, menuActive, route } = this.props;
        return (
            ...
            <div className={styles.normal} style={{ height: screenSize.height * screenRatio() }} id='roottwo'>
                <div className={styles.container} style={{
                    ...
                    {/* <Select /> */}
                    <Menu routeName={route.routes[0].name} name={menuActive} />
                    {children}
                </div>
            </div>
        );
